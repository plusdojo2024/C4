...
<body>
	...
	<main>
		...
		<div>
			<label for="icon">プロフィール写真</label> <input type="file" id="icon"
				name="icon" accept="images/*"> <img
		...
		<form method="post" action="/C4/UpdateServlet">
			...
			<c:forEach var="user" items="${userList}">
				...
				<div>
					<label for="point">ポイント日</label> <input type="text" id="point"
						name="point" value="${user.point}">
				</div>
